...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
	...
	-- lauch tOpen
    , ((modm .|. shiftMask, xK_f     ), spawn "alacritty -e tOpen -t tOpen")

	-- launch Mocp
    , ((modm .|. shiftMask, xK_m     ), spawn "alacritty -e mocp")
    ...
    -- Restart xmonad
    , ((modm              , xK_q     ), spawn "xmonad --flags='with_alsa' --recompile; xmonad --restart")
...
myStartupHook = do
	spawnOnce "feh --bg-center ~/Pictures/Wallpapers/patrick-hendry-MicsxODuffs-unsplash.jpg"
	spawnOnce "picom &"
